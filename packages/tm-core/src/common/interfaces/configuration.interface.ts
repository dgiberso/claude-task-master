...
export interface RuntimeStorageConfig {
        ...
        /** GitHub repository owner (for GitHub storage) */
        githubOwner?: string;
        /** GitHub repository name (for GitHub storage) */
        githubRepo?: string;
        /** GitHub access token (for GitHub storage) */
        githubToken?: string;
        /** Default labels to apply to GitHub issues (for GitHub storage) */
